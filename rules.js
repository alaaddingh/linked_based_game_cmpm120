class Start extends Scene {
    create() {
        ...
        // TODO: replace this text using this.engine.storyData to find the story title
    ...
    handleChoice() {
        ...
        console.log("this");
        console.log(this.engine.storyData.InitialLocation); // TODO: replace this text by the initial location of the story
    }
}
    ...
    create(key) {
        ...
        if(this.engine.storyData.Locations[key].Choices) { // TODO: check if the location has any Choices
            for(let choice of this.engine.storyData.Locations[key].Choices) {
                console.log("this is the current choice:" + this.engine.storyData.Locations[key].Choices + "\n");
